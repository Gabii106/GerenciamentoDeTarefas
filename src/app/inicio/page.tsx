...
Gerenciamento de Turmas</h1>

    {/* Seção de Botões */}
    <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Botão Cadastrar Turmas */}
        <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center">
            <UsersIcon className="h-12 w-12 text-blue-500 mb-4" /> {/* Ícone de
pessoas */}
            <Link href="/turmas/cadastro">
                <button
                    className="bg-blue-500 text-white py-3 px-6 rounded hover:bg-blue-700
focus:outline-none focus:bg-blue-700 transition duration-150"
        >  
...
items-center">
            <ChartBarIcon className="h-12 w-12 text-green-600 mb-4" /> {/* Ícone de
gráfico */}
            <Link href="/turmas/relatorio">
                <button
                    className="bg-green-600 text-white py-3 px-6 rounded
hover:bg-green-800 focus:outline-none focus:bg-green-800 transition duration-150"
            >
